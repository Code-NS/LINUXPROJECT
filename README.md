...
All scripts in this repository are original work written by NIKITA SHROTRIYA, 24BCE10386. All comments and logic are the author's own. Scripts are designed to run on real Linux systems and demonstrate genuine understanding of shell scripting concepts as required by the OSS NGMC course rubric.
